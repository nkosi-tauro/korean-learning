...
<template>
  <div>
    <TransitionRoot as="template" :show="store.sidebarOpen">
      <Dialog class="relative z-50 lg:hidden" @close="store.sidebarOpen = false">
        <TransitionChild 
          as="template" 
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              <TransitionChild 
                ...
                <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
                  <button type="button" class="-m-2.5 p-2.5" @click="store.sidebarOpen = false">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
        <div class="flex h-16 shrink-0 items-center">
          <img 
          class="h-16 w-auto" 
          src="https://oqxhmvxqynvzigcfltib.supabase.co/storage/v1/object/public/products/book.png?t=2023-05-03T21%3A40%3A45.884Z"
          alt="Your Company">
        </div>
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
